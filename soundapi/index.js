                    ...
                    (!(function () {
                                    ...
                                    for (var o = 0; o < n._howls.length; o++)
                                        if (!n._howls[o]._webAudio)
                                            for (var t = n._howls[o]._getSoundIds(), r = 0; r < t.length; r++) {
                                                var i = n._howls[o]._soundById(t[r]);
                            ...
                            _setupCodecs: function () {
                                ...
                                return (
                                    (e._codecs = {
                                        ...
                                        m4a: !!(n.canPlayType("audio/x-m4a;") || n.canPlayType("audio/m4a;") || n.canPlayType("audio/aac;")).replace(
                                            /^no$/,
                                            "",
                                        ),
                                        m4b: !!(n.canPlayType("audio/x-m4b;") || n.canPlayType("audio/m4b;") || n.canPlayType("audio/aac;")).replace(
                                            /^no$/,
                                            "",
                                        ),
                                        mp4: !!(n.canPlayType("audio/x-mp4;") || n.canPlayType("audio/mp4;") || n.canPlayType("audio/aac;")).replace(
                                            /^no$/,
                                            "",
                                        ),
                        ...
                        i.prototype = {
                                ...
                                if (a.noAudio) e._emit("loaderror", null, "No audio support.");
                                    ...
                                    for (var o = 0; o < e._src.length; o++) {
                                        ...
                                        if (e._format && e._format[o]) t = e._format[o];
                                            ...
                                            ((t = /^data:audio\/([^;,]+);/i.exec(r)) || (t = /\.([^.]+)$/.exec(r.split("?", 1)[0])),
                                                t && (t = t[1].toLowerCase()));
                                        }
                                        if (
                                            (t || console.warn('No file extension was found. Consider using the "format" property or specify an extension.'),
                                            t && a.codecs(t))
                                        ) {
                                            n = e._src[o];
                                            break;
                            ...
                            play: function (e, n) {
                                ...
                                if ("number" == typeof e) ((t = e), (e = null));
                                    ...
                                    if (void 0 === e && ((e = "__default"), !o._playLock)) {
                                        for (var r = 0, i = 0; i < o._sounds.length; i++)
                                            o._sounds[i]._paused && !o._sounds[i]._ended && (r++, (t = o._sounds[i]._id));
                                        1 === r ? (e = null) : (t = null);
                                    }
                                }
                                ...
                                if (!(s >= p)) {
                                    ...
                                    if (o._webAudio) {
                                        ...
                                        var h = function () {
                                            ((m.currentTime = s),
                                                (m.muted = u._muted || o._muted || a._muted || m.muted),
                                                (m.volume = u._volume * a.volume()),
                                                (m.playbackRate = u._rate));
                                            try {
                                                var t = m.play();
                                                if (
                                                    (t && "undefined" != typeof Promise && (t instanceof Promise || "function" == typeof t.then)
                                                        ? ((o._playLock = !0),
                                                          f(),
                                                          t
                                                              .then(function () {
                                                        ...
                                                        : n || ((o._playLock = !1), f(), o._emit("play", u._id)),
                                                    (m.playbackRate = u._rate),
                                                    m.paused)
                                                )
                                                    return void o._emit(
                                        ...
                                        if (m.readyState >= 3 || g) h();
                                        else {
                                            ((o._playLock = !0), (o._state = "loading"));
                                            var y = function () {
                                                ((o._state = "loaded"), h(), m.removeEventListener(a._canPlayEvent, y, !1));
                                            };
                                            (m.addEventListener(a._canPlayEvent, y, !1), o._clearTimer(u._id));
                                        }
                                    }
                                    return u._id;
                                }
                            ...
                            volume: function () {
                                ...
                                if (!(void 0 !== e && e >= 0 && e <= 1)) return (o = n ? t._soundById(n) : t._sounds[0]) ? o._volume : 0;
                                ...
                                for (var d = 0; d < n.length; d++)
                                    (o = t._soundById(n[d])) &&
                                        ((o._volume = e),
                                        r[2] || t._stopFade(n[d]),
                                        t._webAudio && o._node && !o._muted
                                            ? o._node.gain.setValueAtTime(e, a.ctx.currentTime)
                                            : o._node && !o._muted && (o._node.volume = e * a.volume()),
                                ...
                                ((e._fadeTo = o),
                                    (e._interval = setInterval(function () {
                                        ...
                                        ((_ = Date.now()),
                                            ...
                                            (u = d < 0 ? Math.max(o, u) : Math.min(o, u)),
                            ...
                            _stopFade: function (e) {
                                ...
                                return (
                                    o &&
                                        o._interval &&
                                        (n._webAudio && o._node.gain.cancelScheduledValues(a.ctx.currentTime),
                                    ...
                                    (o = t._soundById(a[i])) &&
                                        ...
                                        t._webAudio &&
                                            ...
                                            e &&
                                                ...
                                                t.playing(a[i]) && (t.pause(a[i], !0), t.play(a[i], !0)))));
                                return t;
                            },
                            rate: function () {
                                var e,
                                    ...
                                    t = this,
                                    r = arguments;
                                if (0 === r.length) n = t._sounds[0]._id;
                                else if (1 === r.length) {
                                    var i = t._getSoundIds(),
                                        u = i.indexOf(r[0]);
                                    u >= 0 ? (n = parseInt(r[0], 10)) : (e = parseFloat(r[0]));
                                ...
                                for (var d = 0; d < n.length; d++)
                                    if ((o = t._soundById(n[d]))) {
                                        (t.playing(n[d]) && ((o._rateSeek = t.seek(n[d])), (o._playStart = t._webAudio ? a.ctx.currentTime : o._playStart)),
                                            (o._rate = e),
                                            t._webAudio && o._node && o._node.bufferSource
                                                ? o._node.bufferSource.playbackRate.setValueAtTime(e, a.ctx.currentTime)
                                                : o._node && (o._node.playbackRate = e));
                                        var s = t.seek(n[d]),
                                            l = (t._sprite[o._sprite][0] + t._sprite[o._sprite][1]) / 1e3 - s,
                                            _ = (1e3 * l) / Math.abs(o._rate);
                                        ((!t._endTimers[n[d]] && o._paused) || (t._clearTimer(n[d]), (t._endTimers[n[d]] = setTimeout(t._ended.bind(t, o), _))),
                                            t._emit("rate", o._id));
                                    }
                                return t;
                            },
                            seek: function () {
                                var e,
                                    ...
                                    o = this,
                                    t = arguments;
                                if (0 === t.length) o._sounds.length && (n = o._sounds[0]._id);
                                else if (1 === t.length) {
                                ...
                                if (u) {
                                    if (!("number" == typeof e && e >= 0)) {
                                        if (o._webAudio) {
                                            var d = o.playing(n) ? a.ctx.currentTime - u._playStart : 0,
                                ...
                                for (var e = this, n = e._sounds, o = 0; o < n.length; o++)
                                    (n[o]._paused || e.stop(n[o]._id),
                                        e._webAudio ||
                                            ...
                                            n[o]._node.removeEventListener(a._canPlayEvent, n[o]._loadFn, !1),
                                            n[o]._node.removeEventListener("ended", n[o]._endFn, !1),
                                            a._releaseHtml5Audio(n[o]._node)),
                                        delete n[o]._node,
                                        e._clearTimer(n[o]._id));
                                var t = a._howls.indexOf(e);
                                t >= 0 && a._howls.splice(t, 1);
                                var r = !0;
                                for (o = 0; o < a._howls.length; o++)
                                    if (a._howls[o]._src === e._src || e._src.indexOf(a._howls[o]._src) >= 0) {
                                        r = !1;
                                        break;
                                    }
                            ...
                            on: function (e, n, o, t) {
                                var r = this["_on" + e];
                                return ("function" == typeof n && r.push(t ? { id: o, fn: n, once: t } : { id: o, fn: n }), this);
                            },
                            off: function (e, n, o) {
                                var t = this,
                                    r = t["_on" + e],
                            ...
                            _cleanBuffer: function (e) {
                                ...
                                if (a._scratchBuffer && e.bufferSource && ((e.bufferSource.onended = null), e.bufferSource.disconnect(0), n))
                                    try {
                        ...
                        u.prototype = {
                            ...
                            create: function () {
                                var e = this,
                                    n = e._parent,
                                    o = a._muted || e._muted || e._parent._muted ? 0 : e._volume;
                                return (
                                    n._webAudio
                                        ? ((e._node = void 0 === a.ctx.createGain ? a.ctx.createGainNode() : a.ctx.createGain()),
                                          e._node.gain.setValueAtTime(o, a.ctx.currentTime),
                                          (e._node.paused = !0),
                        ...
                        var d = {},
                            ...
                            _ = function (e, n) {
                                var o = function () {
                                    ...
                                    t = function (e) {
                                        e && n._sounds.length > 0 ? ((d[n._src] = e), c(n, e)) : o();
                                    };
                                "undefined" != typeof Promise && 1 === a.ctx.decodeAudioData.length
                                    ? a.ctx.decodeAudioData(e).then(t).catch(o)
                                    : a.ctx.decodeAudioData(e, t, o);
                            },
                            c = function (e, n) {
                            ...
                            p = function () {
                                if (a.usingWebAudio) {
                                    ...
                                    if (e && o && o < 9) {
                                        var t = /safari/.test(a._navigator && a._navigator.userAgent.toLowerCase());
                                        a._navigator && !t && (a.usingWebAudio = !1);
                                    }
                                    (a.usingWebAudio &&
                        ...
                        (void 0 ===
                            ...
                            (n.Howl = i),
                            void 0 !== o.g
                                ? ((o.g.HowlerGlobal = r), (o.g.Howler = a), (o.g.Howl = i), (o.g.Sound = u))
                                : "undefined" != typeof window && ((window.HowlerGlobal = r), (window.Howler = a), (window.Howl = i), (window.Sound = u)));
                    })(),
                        (function () {
                            "use strict";
                            var e;
                            ((HowlerGlobal.prototype._pos = [0, 0, 0]),
                                ...
                                (HowlerGlobal.prototype.pos = function (e, n, o) {
                                    ...
                                    return t.ctx && t.ctx.listener
                                        ? ((n = "number" != typeof n ? t._pos[1] : n),
                                          (o = "number" != typeof o ? t._pos[2] : o),
                                          "number" != typeof e
                                              ? t._pos
                                              : ((t._pos = [e, n, o]),
                                                void 0 !== t.ctx.listener.positionX
                                                    ? (t.ctx.listener.positionX.setTargetAtTime(t._pos[0], Howler.ctx.currentTime, 0.1),
                                                      t.ctx.listener.positionY.setTargetAtTime(t._pos[1], Howler.ctx.currentTime, 0.1),
                                                      t.ctx.listener.positionZ.setTargetAtTime(t._pos[2], Howler.ctx.currentTime, 0.1))
                                            ...
                                            : ((i._orientation = [e, n, o, t, r, a]),
                                              void 0 !== i.ctx.listener.forwardX
                                                  ? (i.ctx.listener.forwardX.setTargetAtTime(e, Howler.ctx.currentTime, 0.1),
                                                    ...
                                                    i.ctx.listener.forwardZ.setTargetAtTime(o, Howler.ctx.currentTime, 0.1),
                                                    i.ctx.listener.upX.setTargetAtTime(t, Howler.ctx.currentTime, 0.1),
                                ...
                                (Howl.prototype.init =
                                    ...
                                    function (n) {
                                        var o = this;
                                        return (
                                            (o._orientation = n.orientation || [1, 0, 0]),
                                            ...
                                            (o._onstereo = n.onstereo ? [{ fn: n.onstereo }] : []),
                                            (o._onpos = n.onpos ? [{ fn: n.onpos }] : []),
                                            (o._onorientation = n.onorientation ? [{ fn: n.onorientation }] : []),
                                            e.call(this, n)
                                        );
                                    })),
                                ...
                                (Howl.prototype.pos = function (e, o, t, r) {
                                    ...
                                    if (((o = "number" != typeof o ? 0 : o), (t = "number" != typeof t ? -0.5 : t), void 0 === r)) {
                                                ...
                                                d._node &&
                                                    ...
                                                    void 0 !== d._panner.positionX
                                                        ? (d._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime),
                                                          d._panner.positionY.setValueAtTime(o, Howler.ctx.currentTime),
                                                          d._panner.positionZ.setValueAtTime(t, Howler.ctx.currentTime))
                                                        : d._panner.setPosition(e, o, t)),
                                                a._emit("pos", d._id));
                                        }
                                    }
                                    return a;
                                ...
                                (Howl.prototype.orientation = function (e, o, t, r) {
                                    ...
                                    if (
                                        ((o = "number" != typeof o ? a._orientation[1] : o), (t = "number" != typeof t ? a._orientation[2] : t), void 0 === r)
                                    ) {
                                                ...
                                                d._node &&
                                                    ...
                                                    void 0 !== d._panner.orientationX
                                                        ? (d._panner.orientationX.setValueAtTime(e, Howler.ctx.currentTime),
                                                          d._panner.orientationY.setValueAtTime(o, Howler.ctx.currentTime),
                                                          d._panner.orientationZ.setValueAtTime(t, Howler.ctx.currentTime))
                                                        : d._panner.setOrientation(e, o, t)),
                                    ...
                                    return function () {
                                        ...
                                        return (
                                            ...
                                            n._stereo
                                                ? o.stereo(n._stereo)
                                                : n._pos
                                                  ? o.pos(n._pos[0], n._pos[1], n._pos[2], n._id)
                                                  : n._panner && (n._panner.disconnect(0), (n._panner = void 0), o._refreshBuffer(n)),
                                            e.call(this)
                                        );
                                    };
        ...
        return (
            (() => {
                ...
                var e = o(766),
                    n = o.n(e);
                const r = (e, ...n) => {
                        void 0 !== window.mp && window.mp.trigger(e, ...n);
                    },
                    a = {
                        "inventory/open_inv": "cloud/sound/inventory/open_inv.ogg",
                        "inventory/close_inv": "cloud/sound/inventory/close_inv.ogg",
                        "inventory/clothes": "cloud/sound/inventory/clothes.ogg",
                        "inventory/drag_drop": "cloud/sound/inventory/drag_drop.ogg",
                        "inventory/drink": "cloud/sound/inventory/drink.ogg",
                        "inventory/eat": "cloud/sound/inventory/eat.ogg",
                        "inventory/keys": "cloud/sound/inventory/keys.ogg",
                        "inventory/medkit": "cloud/sound/inventory/medkit.ogg",
                        "inventory/onoff_bag": "cloud/sound/inventory/onoff_bag.ogg",
                        "phone/bonus_activated": "cloud/sound/phone/bonus_activated.ogg",
                        "phone/click": "cloud/sound/phone/click.ogg",
                        "phone/in_call": "cloud/sound/phone/in_call.ogg",
                        "phone/in_sms": "cloud/sound/phone/in_sms.ogg",
                        "phone/out_call": "cloud/sound/phone/out_call.ogg",
                        "phone/out_sms": "cloud/sound/phone/out_sms.ogg",
                        "phone/phone_activated": "cloud/sound/phone/activated.ogg ",
                        "other/house_doors": "cloud/sound/other/house_doors.ogg",
                        "other/house_key": "cloud/sound/other/house_key.ogg",
                        "other/sell_house": "cloud/sound/other/sell_house.ogg",
                        "other/add_ad": "cloud/sound/other/add_ad.ogg",
                        "festive/bring": "cloud/sound/festive/bring.ogg",
                        "festive/put": "cloud/sound/festive/put.ogg",
                        "festive/sounds": "cloud/sound/festive/sounds.ogg",
                        "breakingLock/tick": "cloud/sound/breakingLock/tick.ogg",
                        "vape/one": "cloud/sound/vape/one.ogg",
                        "bong/bong": "cloud/sound/bong/bong.ogg",
                        "kalik/kalik": "cloud/sound/kalik/kalik.ogg",
                        "radio/on": "cloud/sound/radio/on.ogg",
                        "radio/off": "cloud/sound/radio/off.ogg",
                        cuffs: "cloud/sound/polic/cuffs.ogg",
                        zips: "cloud/sound/polic/zips.ogg",
                        "mafia/start": "cloud/sound/mafia/start.mp3",
                        "mafia/role_take": "cloud/sound/mafia/role_take.mp3",
                        "mafia/night_mafia": "cloud/sound/mafia/night_mafia.mp3",
                        "mafia/night_komisar": "cloud/sound/mafia/night_komisar.mp3",
                        "mafia/night_doctor": "cloud/sound/mafia/night_doctor.mp3",
                        "mafia/night_courtesan": "cloud/sound/mafia/night_courtesan.mp3",
                        "mafia/new_day": "cloud/sound/mafia/new_day.mp3",
                        "mafia/day_discussion": "cloud/sound/mafia/day_discussion.mp3",
                        "mafia/day_vote": "cloud/sound/mafia/day_vote.mp3",
                        "mafia/peaceful_win": "cloud/sound/mafia/peaceful_win.mp3",
                        "mafia/mafia_win": "cloud/sound/mafia/mafia_win.mp3",
                    },
                    i = "https://krutiachok.github.io/server-cdn/",
                    u = { soundPool: {}, ambientMusicPool: {}, streamRadio: null, radio2D: null, ambientMusic2: null },
                    d = { px: null, py: null, pz: null, ofx: null, ofy: null, ofz: null, oux: null, ouy: null, ouz: null, Value: !1 },
                    s = () => {
                        const e = d;
                        e.Value = !e.Value;
                        const o = e.Value ? 1e-4 : 0;
                        (null != e.px && null != e.py && null != e.pz && n().Howler.pos(e.px + o, e.py + o, e.pz + o),
                            null != e.ofx &&
                                null != e.ofy &&
                                null != e.ofz &&
                                null != e.oux &&
                                null != e.ouy &&
                                null != e.ouz &&
                                n().Howler.orientation(e.ofx + o, e.ofy + o, e.ofz + o, e.oux + o, e.ouy + o, e.ouz + o),
                            requestAnimationFrame(s));
                    };
                (requestAnimationFrame(s),
                    (window.playAmbientMusic = (e) => {
                        const o = (e = JSON.parse(e)).soundId || e.sound,
                            t = u.ambientMusicPool[o];
                        t && (t.stop(), delete u.ambientMusicPool[o]);
                        const d = new (n().Howl)({
                            volume: e.volume,
                            ...
                            onend() {
                                e.loop ||
                                    (u.ambientMusicPool[o] && (u.ambientMusicPool[o].stop(), delete u.ambientMusicPool[o]),
                                    r("sounds.trigger", "onAmbientMusicEnd", o));
                            },
                            onload() {
                                if (!u.ambientMusicPool[o]) return delete u.ambientMusicPool[o];
                                if (e.syncAudio > 0) {
                                    const n = d.duration(),
                                        o = ((Date.now() - e.syncAudio) / 1e3) % n || 0;
                                    d.seek(o);
                                } else if (!isNaN(e.startOffsetPercent)) {
                                    const n = d.duration(),
                                        o = (e.startOffsetPercent * n) / 100;
                                    d.seek(o);
                                }
                                (d.play(), d.fade(0, e.volume, isNaN(e.fade) ? 2500 : e.fade));
                            },
                        });
                        ((d.name = e.sound), (d.defaultVolume = e.volume), (u.ambientMusicPool[o] = d));
                    }),
                    (window.stopAmbientMusic = (e) => {
                        if (!e) return;
                        e = JSON.parse(e);
                        const n = u.ambientMusicPool[e.soundId];
                        if (n) {
                            const o = 2e3;
                            e.force
                                ? (n.stop(), delete u.ambientMusicPool[e.soundId])
                                : (n.fade(n.defaultVolume, 0, o),
                                  n.on("fade", () => {
                                      n && (n.stop(), delete u.ambientMusicPool[e.soundId]);
                                  }));
                        }
                    }),
                    (window.playAmbientMusic2 = (e) => {
                        ((e = JSON.parse(e)), u.ambientMusic2 && u.ambientMusic2.stop());
                        const o = new (n().Howl)({
                            volume: 0,
                            src: a[e.sound] ? [i + a[e.sound]] : [i + e.sound],
                            loop: e.loop,
                            html5: !0,
                            onend() {
                                e.loop || (u.ambientMusic2 = null);
                            },
                        });
                        ((o.name = e.sound), (o.defaultVolume = e.volume), o.play(), o.fade(0, e.volume, 2500), (u.ambientMusic2 = o));
                    }),
                    (window.stopAmbientMusic2 = () => {
                        u.ambientMusic2 &&
                            (u.ambientMusic2.fade(u.ambientMusic2.defaultVolume, 0, 2e3),
                            u.ambientMusic2.on("fade", () => {
                                u.ambientMusic2 && (u.ambientMusic2.stop(), (u.ambientMusic2 = null));
                            }));
                    }),
                    (window.stopSound = (e) => {
                        const n = u.soundPool[e];
                        n && (n.stop(), delete u.soundPool[e], r("sounds.trigger", "onEnd", e));
                    }),
                    (window.stop2DRadio = () => {
                        u.radio2D && (u.radio2D.stop(), (u.radio2D = null));
                    }),
                    (window.play2DRadio = (e) => {
                        ((e = JSON.parse(e)), u.radio2D && u.radio2D.stop());
                        const o = new (n().Howl)({
                            src: e.url,
                            html5: !0,
                            volume: null != e.volume ? parseFloat(e.volume) : 0.06,
                            format: ["mp3"],
                            autoplay: !0,
                            onend: () => {
                                u.radio2D = null;
                    ...
                    (window.play3DSound = (e) => {
                        ...
                        const t = new (n().Howl)({
                            ...
                            d = (n) => {
                                ...
                                if (e.syncAudio > 0) {
                                    const o = n.duration(),
                                        t = ((Date.now() - e.syncAudio) / 1e3) % o || 0;
                                    n.seek(t);
                                } else if (!isNaN(e.startOffsetPercent)) {
                                    const o = n.duration(),
                                        t = (e.startOffsetPercent * o) / 100;
                                    n.seek(t);
                                }
                                let t = {
                                    panningModel: "equalpower",
                                    maxDistance: e.maxDistance,
                                    rolloffFactor: e.rolloffFactor ? e.rolloffFactor : 1,
                                    refDistance: e.refDistance ? e.refDistance : 1,
                                    distanceModel: "linear",
                                };
                                (null != e.pannerAttr && (t = { ...t, ...e.pannerAttr }),
                                    n.pannerAttr(t),
                                    n.play(),
                                    isNaN(e.fade) || n.fade(0, e.volume, e.fade));
                            };
                        u.soundPool[o] = t;
                    }),
                    (window.updateAllSoundPos = (e) => {
                        e = JSON.parse(e);
                        const o = u.soundPool[e.sid];
                        o && (o.pos(e.sx, e.sy, e.sz), n().Howler.pos(e.px, e.py, e.pz), n().Howler.orientation(e.ox, e.oy, e.oz, 0, 1, 0));
                    }),
                    (window.updatePlayerSoundPos = (e) => {
                        (null != (e = JSON.parse(e)).px && null != e.py && null != e.pz && ((d.px = e.px), (d.py = e.py), (d.pz = e.pz)),
                            null != e.ofx &&
                                null != e.ofy &&
                                null != e.ofz &&
                                null != e.oux &&
                                null != e.ouy &&
                                null != e.ouz &&
                                ((d.ofx = e.ofx), (d.ofy = e.ofy), (d.ofz = e.ofz), (d.oux = e.oux), (d.ouy = e.ouy), (d.ouz = e.ouz)));
                    }),
                    (window.updateSoundPos = (e) => {
                        e = JSON.parse(e);
                        const n = u.soundPool[e.id];
                        n && n.pos(e.x, e.y, e.z);
                    }),
                    (window.setMuted = (e) => {
                        e = JSON.parse(e);
                    ...
                    (window.cache = (e) => {
                        ((e = JSON.parse(e)), new (n().Howl)({ src: a[e.sound] ? [i + a[e.sound]] : [i + e.sound], volume: 0, preload: !0 }).play());
                    }));
            })(),
            t
        );
